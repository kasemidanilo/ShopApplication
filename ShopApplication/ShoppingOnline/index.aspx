...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <Services>
            <asp:ServiceReference Path ="C:\Users\Danilo\Documents\Visual Studio 2015\Projects\ShopApplication\ShopApplication\ShoppingOnline\App_Code\OnlineShop.cs"/>
            </Services>
        </asp:ScriptManager>
	...
	<!--start-logo-->
	<div class="logo">
		<a href="index.aspx"><h1 id ="test2">Luxury Watches</h1></a>
	</div>
	<!--start-logo-->
	<!--bottom-header-->
			...
			<div class="footer-top">
				<div class="col-md-6 footer-left">
					<form>
						...
						<input type="button" id ="subs" value="Subscribe" runat ="server" onclick="test()">
					</form>
				</div>
